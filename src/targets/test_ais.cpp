...
int main() {
  {
    ...
    gameAdmin.runGame(gameSettings, [] (
      ...
      playerAis.emplace_back(std::make_unique<HumanPlayerAI>(players[0], enemyPlayerLists[0], board, std::cin, &std::cout));
...

  {
    ...
    //       playerAis.emplace_back(std::make_unique<RandomPlayerAI>(players[i], enemyPlayerLists[i], board, nullptr));
    //     }
    //     return playerAis;
    //   });
    // }
...

  {
    ...
    //         playerAis.emplace_back(std::make_unique<RandomPlayerAI>(players[i], enemyPlayerLists[i], board, nullptr));
    //       } else {
    //         playerAis.emplace_back(std::make_unique<GreedyPlayerAI>(players[i], enemyPlayerLists[i], board, nullptr));
    //       }
    //     }
    //     return playerAis;
    //   });
...

  {
    ...
    //         playerAis.emplace_back(std::make_unique<GreedyPlayerAI>(players[i], enemyPlayerLists[i], board, nullptr));
    //       } else {
    //         playerAis.emplace_back(std::make_unique<SmartPlayerAI>(players[i], enemyPlayerLists[i], board, nullptr));
    //       }
    //     }
    //     return playerAis;
    //   });
